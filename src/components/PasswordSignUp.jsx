  ...
  return (
    <>
      ...
      >
        ...
        />
        <span
          className={`text-red-700 text-sm w-[270px] md:w-[300px] text-center hidden peer-placeholder-shown:!invisible peer-invalid:flex absolute bottom-[13%] md:bottom-[22%]`}
        >
